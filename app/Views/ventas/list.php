<div class="row mt-4">
  ...
  <div class="col-12 col-sm-4 text-right" style="text-align:right">
    <!-- <a href="<?php //base_url()."/$path/index/".($onOff == 0?"1":"0")?>" class="btn btn-warning"><?php //$switch?></a>
    <?php // if ($onOff) {?>
      <a href="<?php //base_url()."/$path/nueva"?>" class="btn btn-primary">Nueva</a> -->
      <!-- <a href="<?php //base_url()."/$path/agregar"?>" class="btn btn-primary">Agregar</a> -->
    <!-- <?php //} ?> -->
  </div>
</div>
<div class="mt-3">
